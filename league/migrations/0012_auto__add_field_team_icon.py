...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('league_team', 'icon',
                      self.gf('django.db.models.fields.files.FileField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.icon'
        db.delete_column('league_team', 'icon')
    ...
    models = {
        ...
        'league.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 4, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
