...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.tiers'
        db.add_column('tournament_tournament', 'tiers',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Tournament.generated'
        db.add_column('tournament_tournament', 'generated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.tiers'
        db.delete_column('tournament_tournament', 'tiers')

        # Deleting field 'Tournament.generated'
        db.delete_column('tournament_tournament', 'generated')
