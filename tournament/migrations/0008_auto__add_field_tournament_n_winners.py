...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.n_winners'
        db.add_column('tournament_tournament', 'n_winners',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.n_winners'
        db.delete_column('tournament_tournament', 'n_winners')
    ...
    models = {
        ...
        'tournament.matchup': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 8, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tier': ('django.db.models.fields.FloatField', [], {}),
        ...
        'tournament.tournament': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'n_winners': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            ...
            'tiers': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        }
    }
