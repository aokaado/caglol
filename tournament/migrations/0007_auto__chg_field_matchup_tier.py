...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matchup.tier'
        db.alter_column('tournament_matchup', 'tier', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Matchup.tier'
        db.alter_column('tournament_matchup', 'tier', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'tournament.matchup': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 10, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
