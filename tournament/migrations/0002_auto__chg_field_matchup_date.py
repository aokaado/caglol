...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matchup.date'
        db.alter_column('tournament_matchup', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Matchup.date'
        db.alter_column('tournament_matchup', 'date', self.gf('django.db.models.fields.DateField')())
